...
TESTS = test_simple_gc test_visualizer test_stack_scan test_memory_pools test_compaction test_memory_pressure test_gc_large test_gc_mark test_gc_sweep test_generational test_trace test_debug
