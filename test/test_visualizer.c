...
static MunitTest tests[] = {
    {"/default_config", test_viz_default_config, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {"/type_string", test_viz_type_string, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {"/heap_bar", test_viz_heap_bar, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {"/object_list", test_viz_object_list, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {"/reference_graph", test_viz_reference_graph, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {"/stats_dashboard", test_viz_stats_dashboard, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {"/full_state", test_viz_full_state, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {"/snapshot", test_viz_snapshot, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {"/snapshot_marked", test_viz_snapshot_marked_states, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {"/diff", test_viz_diff, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {NULL, NULL, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL}};

static const MunitSuite suite = {"/visualizer", tests, NULL, 1, MUNIT_SUITE_OPTION_NONE};
